# Step 4: Run Your Pipeline & Deploy Agents 🚀

## 🎯 Your Mission

Execute the pipeline you created in Step 3 and successfully deploy AI agents to all three environments. Monitor the execution, troubleshoot any failures, and verify your agents are running in Azure AI Foundry.
...
git commit -m "Step 4: Deployed agents to all environments"
