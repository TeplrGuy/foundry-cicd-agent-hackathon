...
# Use AZURE_AI_PROJECT_ENDPOINT (same as createagent.py and exagent.py)
endpoint = os.environ.get("AZURE_AI_PROJECT_ENDPOINT") or os.environ.get("AZURE_AI_PROJECT")
